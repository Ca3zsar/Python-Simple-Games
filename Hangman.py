...
def getRandomWord(wordList):
    # This functions return a random string from the passed list of strings
...
def getGuess(alreadyGuessed):
    # Return the letter the player entered. This function makes sure the player entered a single
    ...
    while True:
        ...
        elif guess not in "abcdefghijklmnopqrstuivwxyz":
