...
def drawBoard(board):
    ...
    # "board" is a list of 10 stings represeting the board (ignore index 0)
...
def getComputerMove(board,computerLetter):
    ...
    move = chooseRandmMoveFromList(board,[1,3,7,9])
    if move != None:
        return move
    ...
    return chooseRandmMoveFromList(board,[2,4,6,8])
